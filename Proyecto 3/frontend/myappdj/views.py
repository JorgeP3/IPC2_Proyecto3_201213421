...
#create yout views here
        ...
        #una vista es un segmento o un modulo,
                #fdjango va a dar el request cuando vamos a renderizar
def myform_view(request):
    if request.method == 'POST':
        data = request.POST.get("data")
        file = request.FILES.get("file")#recuperamos file
